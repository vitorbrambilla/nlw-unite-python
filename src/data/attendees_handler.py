...
class AttendeesHandler:
    ...
    def registry(self, http_request: HttpRequest) -> HttpResponse:
        ...
        attendees_count = self.__events_repository.count_event_attendees(
            event_id
        )

        if (
            attendees_count["attendeesAmount"] and
            attendees_count["maximum_attendees"] <
            attendees_count["attendeesAmount"]
        ):
    ...
    def find_attendee_badge(self, http_request: HttpRequest) -> HttpResponse:
        ...
        if not badge:
            raise HttpNotFoundError("Badge not found")
